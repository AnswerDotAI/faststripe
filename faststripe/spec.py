...
# %% auto #0
__all__ = ['stripe_openapi_url', 'stripe_spec', 'docs_url', 'pat', 'obj_typs', 'build_eps', 'update_version']
...
# %% ../nbs/00_spec.ipynb #c527196d
docs_url = 'https://docs.stripe.com/api'

# %% ../nbs/00_spec.ipynb #f997d803
...
# %% ../nbs/00_spec.ipynb #308dd955
obj_typs = set()
for s in stripe_spec['components']['schemas'].values():
    obj = s.get('properties', {}).get('object', {})
    if 'enum' in obj: obj_typs.update(obj['enum'])
