...
```
    ...
    ('prod_TWBpw6Ul4FTu0e', 'Test Product')

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L122"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('prod_TWBpyb5grSXmv5', 'Test Product')
...
```
    ...
    ('price_1SZ9SHKGhqIw9PXm3QLKg14S', 1000, 'usd')
...
- [checkout.sessions_get](https://docs.stripe.com/api/sessions/list)(created:
  ...
  ending_before: ‘str’ = None, expand: ‘str’ = None, limit: ‘str’ =
  None, payment_intent: ‘str’ = None, payment_link: ‘str’ = None,
...
- [checkout.sessions_session_get](https://docs.stripe.com/api/sessions/delete)(session,
  expand: ‘str’ = None): *Retrieve a Checkout Session*
...
- [checkout.sessions_session_line_items_get](https://docs.stripe.com/api/line_items/delete)(session,
  ending_before: ‘str’ = None, expand: ‘str’ = None, limit: ‘str’ =
  None, starting_after: ‘str’ = None): *Retrieve a Checkout Session’s
  line items*
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1ql3yMAUjV0ARvRF0TItcGl...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L128"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L145"
target="_blank" style="float:right; font-size:smaller">source</a>

### StripeApi.find_product

>  StripeApi.find_product (name:str, limit=100, active:str=None,
>                              created:str=None, ending_before:str=None,
>                              expand:list=None, ids:str=None,
>                              shippable:str=None, starting_after:str=None,
>                              url:str=None)
...
>  StripeApi.find_prices (product_id:str, limit=100, active:str=None,
>                             created:str=None, currency:str=None,
>                             ending_before:str=None, expand:list=None,
>                             lookup_keys:str=None, product:str=None,
>                             recurring:str=None, starting_after:str=None,
>                             type:str=None)
...
```
    ...
    (#1) [{'id': 'price_1SYYzRKGhqIw9PXmRpK65x9z', 'object': 'price', 'active': True, 'billing_scheme': 'per_unit', 'created': 1764364445, 'currency': 'usd', 'custom_unit_amount': None, 'livemode': False, 'lookup_key': None, 'metadata': {}, 'nickname': None, 'product': 'prod_TVa9FckoLTcYy4', 'recurring': None, 'tax_behavior': 'unspecified', 'tiers_mode': None, 'transform_quantity': None, 'type': 'one_time', 'unit_amount': 1000, 'unit_amount_decimal': '1000'}]

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L159"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('Test Product', 'price_1SYYzRKGhqIw9PXmRpK65x9z', 1000)
...
>                                  cancel_url, currency='usd', quantity=1,
>                                  adaptive_pricing:dict=None,
>                                  after_expiration:dict=None,
>                                  allow_promotion_codes:bool=None,
>                                  automatic_tax:dict=None,
>                                  billing_address_collection:str=None,
>                                  branding_settings:dict=None,
>                                  client_reference_id:str=None,
>                                  consent_collection:dict=None,
>                                  custom_fields:list=None,
>                                  custom_text:dict=None, customer:str=None,
>                                  customer_creation:str=None,
>                                  customer_email:str=None,
>                                  customer_update:dict=None,
>                                  discounts:list=None,
>                                  excluded_payment_method_types:list=None,
>                                  expand:list=None, expires_at:int=None,
>                                  invoice_creation:dict=None,
>                                  line_items:list=None, locale:str=None,
>                                  metadata:dict=None, mode:str=None,
>                                  name_collection:dict=None,
>                                  optional_items:list=None,
>                                  origin_context:str=None,
>                                  payment_intent_data:dict=None,
>                                  payment_method_collection:str=None,
...
>                                  phone_number_collection:dict=None,
>                                  redirect_on_completion:str=None,
>                                  return_url:str=None,
>                                  saved_payment_method_options:dict=None,
>                                  setup_intent_data:dict=None,
>                                  shipping_address_collection:dict=None,
>                                  shipping_options:list=None,
>                                  submit_type:str=None,
>                                  subscription_data:dict=None,
>                                  tax_id_collection:dict=None,
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1ctfsdyIp74OxzNEqBIBuoX...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L181"
target="_blank" style="float:right; font-size:smaller">source</a>
...
>                              client_reference_id:str=None,
>                              consent_collection:dict=None,
>                              custom_fields:list=None, custom_text:dict=None,
>                              customer:str=None, customer_creation:str=None,
>                              customer_email:str=None,
>                              customer_update:dict=None, discounts:list=None,
>                              excluded_payment_method_types:list=None,
>                              expand:list=None, expires_at:int=None,
>                              invoice_creation:dict=None, line_items:list=None,
>                              locale:str=None, metadata:dict=None,
>                              mode:str=None, name_collection:dict=None,
>                              optional_items:list=None,
>                              origin_context:str=None,
>                              payment_intent_data:dict=None,
>                              payment_method_collection:str=None,
...
>                              setup_intent_data:dict=None,
>                              shipping_address_collection:dict=None,
>                              shipping_options:list=None, submit_type:str=None,
>                              subscription_data:dict=None,
>                              tax_id_collection:dict=None, ui_mode:str=None,
>                              wallet_options:dict=None)
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1jcBM8mG0TqpAePlrhb7ICU...
