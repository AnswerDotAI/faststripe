...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L149"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('prod_UHQcscapzZce8z', 'Test Product')

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L143"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('prod_UHQc1BG1rZAGX5', 'Test Product')
...
```
    ...
    ('price_1TIrlJKGhqIw9PXmUknjZ9hz', 1000, 'usd')

You also get nice error messages when things go wrong.

``` python
sapi.prices.post(product='abc')
```

    StripeError: StripeError(400): No such product: 'abc' [param: product]
    [31m---------------------------------------------------------------------------[39m
    [31mStripeError[39m                               Traceback (most recent call last)
    [36mCell[39m[36m [39m[32mIn[59][39m[32m, line 1[39m
    [32m----> [39m[32m1[39m sapi.prices.post(product=[33m'abc'[39m)

    [36mCell[39m[36m [39m[32mIn[23][39m[32m, line 20[39m, in [36m_OAPIVerb.__call__[39m[34m(self, *args, **kwargs)[39m
    [32m     16[39m         flds = self.pparams + names(self.qparams) + names(self.data)
    [32m     17[39m         [38;5;28;01mfor[39;00m a, b [38;5;28;01min[39;00m zip(args, flds): kwargs[b] = a
    [32m     18[39m         route_p, query_p, data_p = [{p: kwargs[p] for p in o if p in kwargs}
    [32m     19[39m                                     [38;5;28;01mfor[39;00m o [38;5;28;01min[39;00m (self.pparams, names(self.qparams), names(self.data))]
    [32m---> [39m[32m20[39m         [38;5;28;01mreturn[39;00m self.client(self.path, self.verb, route=route_p, query=query_p, data=data_p)

    [36mCell[39m[36m [39m[32mIn[29][39m[32m, line 23[39m, in [36mStripeApi.__call__[39m[34m(self, path, verb, headers, route, query, data)[39m
    [32m     19[39m         [33m"Call the API endpoint with the given arguments"[39m
    [32m     20[39m         path, verb, headers, query, data = self._prep(path, verb, headers, route, query, data)
    [32m     21[39m         resp = httpx.request(verb, f"{self.base_url}/{path}", headers=headers, params=query, data=data)
    [32m     22[39m         [38;5;28;01mtry[39;00m: resp.raise_for_status()
    [32m---> [39m[32m23[39m         [38;5;28;01mexcept[39;00m httpx.HTTPStatusError [38;5;28;01mas[39;00m e: [38;5;28;01mraise[39;00m StripeError(e) [38;5;28;01mfrom[39;00m [38;5;28;01mNone[39;00m
    [32m     24[39m         self.recv_hdrs = dict(resp.headers)
    [32m     25[39m         [38;5;28;01mreturn[39;00m dict2obj(resp.json())

    [31mStripeError[39m: StripeError(400): No such product: 'abc' [param: product]
...
```
    ...
    ('prod_UHQcn8IPhf9EV1', 'Test Product')
...
- [checkout.sessions_get](https://docs.stripe.com/api/sessions/list)(created:
  ‘str’ = None, customer: ‘str’ = None, customer_account: ‘str’ = None,
  customer_details: ‘str’ = None, ending_before: ‘str’ = None, expand:
  list = None, limit: ‘str’ = None, payment_intent: ‘str’ = None,
  payment_link: ‘str’ = None, starting_after: ‘str’ = None, status:
  ‘str’ = None, subscription: ‘str’ = None): *List all Checkout
  Sessions*
- [checkout.sessions_post](https://docs.stripe.com/api/sessions/create)(adaptive_pricing:
  ...
  None, customer: str = None, customer_account: str = None,
  customer_creation: str = None, customer_email: str = None,
  customer_update: dict = None, discounts: list = None,
  excluded_payment_method_types: list = None, expand: list = None,
  expires_at: int = None, invoice_creation: dict = None, line_items:
  list = None, locale: str = None, metadata: dict = None, mode: str =
  None, name_collection: dict = None, optional_items: list = None,
  origin_context: str = None, payment_intent_data: dict = None,
...
- [checkout.sessions_session_post](https://docs.stripe.com/api/sessions/update)(session,
  collected_information: dict = None, expand: list = None, line_items:
  list = None, metadata: object = None, shipping_options: object =
  None): *Update a Checkout Session*
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1plZDmlVCp89BXrxxPZ3jmF...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L161"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L171"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L178"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L186"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L192"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('Test Product', 'price_1TIrlqKGhqIw9PXm9qF21Sql', 1000)
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L205"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1Hnude6LmQN3TPl7jh2AErX...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L215"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a16xqRt5IuAMUteUgVFzqvtx...
