...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L97"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('prod_TNHAZwYYR6GSuX', 'Test Product')

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L120"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('prod_TNHA6E985BYnpU', 'Test Product')
...
```
    ...
    ('price_1SQWcVKGhqIw9PXmKEyLReNI', 1000, 'usd')
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a13uM2EdNN6qlVtbHw079cvg...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L127"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L134"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    (#1) [{'id': 'price_1SQWcVKGhqIw9PXmKEyLReNI', 'object': 'price', 'active': True, 'billing_scheme': 'per_unit', 'created': 1762448711, 'currency': 'usd', 'custom_unit_amount': None, 'livemode': False, 'lookup_key': None, 'metadata': {}, 'nickname': None, 'product': 'prod_TNHA6E985BYnpU', 'recurring': None, 'tax_behavior': 'unspecified', 'tiers_mode': None, 'transform_quantity': None, 'type': 'one_time', 'unit_amount': 1000, 'unit_amount_decimal': '1000'}]

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L140"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    ('Test Product', 'price_1SQWcVKGhqIw9PXmKEyLReNI', 1000)
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L152"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1RybLvOE97UV7x6xqNIe5ni...
...
<a
href="https://github.com/AnswerDotAI/faststripe/blob/main/faststripe/core.py#L160"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1E1U8PGekHyFPEOfRVBgP6g...
