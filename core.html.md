...
```
    ...
    ('prod_SzKk5vimnGOPFV', 'Test Product')
...
```
    ...
    ('prod_SzKkuFyEy2VbYy', 'Test Product')
...
```
    ...
    ('price_1S3M59KGhqIw9PXmSZlub7hx', 1000, 'usd')
...
- [checkout.sessions_post](https://docs.stripe.com/api/sessions/create)(adaptive_pricing:
  ...
  mode: str = None, optional_items: list = None, origin_context: str =
  None, payment_intent_data: dict = None, payment_method_collection: str
  = None, payment_method_configuration: str = None, payment_method_data:
  dict = None, payment_method_options: dict = None,
  payment_method_types: list = None, permissions: dict = None,
  phone_number_collection: dict = None, redirect_on_completion: str =
  None, return_url: str = None, saved_payment_method_options: dict =
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1ZXGpnLbCo9Xsklx3N4qNnp...
...
```
    ...
    (#1) [{'id': 'price_1S3M59KGhqIw9PXmSZlub7hx', 'object': 'price', 'active': True, 'billing_scheme': 'per_unit', 'created': 1756926659, 'currency': 'usd', 'custom_unit_amount': None, 'livemode': False, 'lookup_key': None, 'metadata': {}, 'nickname': None, 'product': 'prod_SzKkuFyEy2VbYy', 'recurring': None, 'tax_behavior': 'unspecified', 'tiers_mode': None, 'transform_quantity': None, 'type': 'one_time', 'unit_amount': 1000, 'unit_amount_decimal': '1000'}]
...
```
    ...
    ('Test Product', 'price_1S3M59KGhqIw9PXmSZlub7hx', 1000)
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a14MZJzItRw82sYOo6AJhFQe...
...
```
    ...
    Payment link: https://billing.answer.ai/c/pay/cs_test_a1ERFkJOGAKg8iLb3r6JWFf4...
